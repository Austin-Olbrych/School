// Jim Klayder -- February 2017 -- this class show how to use an image in Animator11
/////////////////////////////////////////////////////////////////////
//   naming conventions
...
/*
The turkey used by this class began its life as a Google image. 
It had a white background, so it was converted into a transparent 
image using Preview. 
*/

//start class
function Madagascar(name, age, over, down)
{
	...
	_g_anotherTest = 457;    //global public var accessible in any active object of any class
	
	//alert("Here is Madagascar");
	...
	this.xList = [ -30, -25, -20, -15, -10, 
				   -5, 0, 5, 10, 15, 20 ,25,30,35,40,45,50,55,60,75,80,85,90,95,100,
				   105,110,115,120,125,130,135,140,145,150,155,160,165,170,175,180,
				   185,190,195,200,205,210,215,220,225,230,240,250,260,270,280,290,300,
				   310,325,345,365,385,405,425,450,475,500,525,550,550,550,550,550,550,
				   550,550,550,550,550,550,550,550,550,550,550,550,550,550,550,550,550,550]
	this.yList = [ 180, 180, 180, 180 , 180, 180, 
				   180, 180, 180, 180, 180, 180, 180 , 180, 180,
				   180, 180, 180, 180, 180, 180, 180 , 180, 180, 
				   180, 180, 180, 180, 170, 170, 170 , 170, 170,
				   155, 155, 155, 155, 155, 155, 155 , 155, 155, 
				   170, 170, 170, 170, 180, 180, 180 , 180, 180,
				   180, 180, 180, 180, 180, 180, 180 , 180, 180, 
				   180, 180, 180, 180, 180, 180, 180 , 180, 180,
				   180, 180, 180, 180, 180, 180, 180 , 180, 180, 
				   180, 180, 180, 180, 180, 180, 180 , 180, 180]
	...
	this.draw = function draw(context)
		{
			...
			//.fillText("Turkey will stop at 300", 30, 290);
		    ...
		    //display the image
			img = document.getElementById("madagascar");
