...
/////////////////////////////////////////////////////////////////////
//start class
function Door(name, age, theOver, theDown)
{
	...
	this.draw = function draw(context)
		{
			...
			context.fillRect(this.over + 10,this.down,10,_size);
			context.fillRect(this.over + 30,this.down,10,_size);
			context.fillRect(this.over + 50,this.down,10,_size);
			context.fillRect(this.over + 70,this.down,10,_size);
			context.fillRect(this.over + 90,this.down,10,_size);
