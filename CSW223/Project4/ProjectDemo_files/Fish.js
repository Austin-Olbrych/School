...
/////////////////////////////////////////////////////////////////////
//start class
function Fish(name, age, theOver, theDown)
{
	...
	this.draw = function draw(context)
		{
			...
			context.beginPath();
			context.moveTo(this.over + 10, this.down + 15);
			context.lineTo(this.over + 50 , this.down);
			context.lineTo(this.over + 50, this.down + 30);
			context.fill();
	...
	this.move = function move()
		{
			if(this.canDrag){
				...
				overOffset = getRandomInt(-10,0);
				downOffset = getRandomInt(-5,5);
			
				this.over += overOffset;
				this.down += downOffset;
