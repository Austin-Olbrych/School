...
/////////////////////////////////////////////////////////////////////
//start class
function Zebra(name, age, theOver, theDown)
{
	...
	var _size = 100;
	var img = document.getElementById("zebra");
	...
	*/
	...
	this.setCenterLocationTo = function setCenterLocationTo(point)
	{
		...
		myClickArea = new MyClickArea(this.over + 10, 
									this.down, 
									_clickAreaWidth + 50, _clickAreaHeight + 70);
	...
	this.draw = function draw(context)
		{
			context.drawImage(img, this.over, this.down, _size *2, _size *2);
