...
*/
function PagePaintZebra(pageName, animationList, optionList)
{
	...
	{		
		if (this.userSelectedObject != null)
		{
			...
			if (nameOfLastObject == "zebra")
			{
				if (lastObject.hitTest(point))
				{
					if(this.userSelectedObject.getName() == 'white'){
						alert('You are covered in white paint');
